...
st.markdown(
    '''
        ...
        A PNAD COVID-19, realizada pelo IBGE, é uma das principais fontes de informação 
        sobre os brasileiros para análise. Neste trabalho, você irá conferir alguns insights e ações que os hospitais podem tomar para o caso de um novo surto.
        ...
        Dica: Leiam com atenção a base de dados e toda a documentação que o site o PNAD-COVID-19 traz, principalmente os dicionários, que ajudam e muito no entendimento da Base de Dados. Utilizem o que já foi ensinado e consolidado nas outras fases para apresentar a resolução do projeto.
